 ...
 *
 * @param isDoubleTime - The specification to whether or not to retrieve the beatmap with the double time statistics, the no modification statistics or random statistics.
...
const requestBeatmap = async (
	...
	} else return { beatmap: await retrieveBeatmapRequest(isDoubleTime, filters), isDoubleTime };
};
