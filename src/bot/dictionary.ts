 ...
 */
const incorrectFilters = (guessedAlternatives: string) => `The provided [${process.env.WIKI_URL} filters] are incorrect or not allowed, try using: "${guessedAlternatives}"`;
const noBeatmapsFound = 'No beatmaps available for the provided filters, reduce the number of filters or remove bursts/streams/deathstreams filters if you are also using the average filter';
